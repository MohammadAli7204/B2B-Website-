...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    content: 'The AAMI (Association for the Advancement of Medical Instrumentation) PB70 standard is the industry benchmark for liquid barrier performance and classification of protective apparel and drapes intended for use in healthcare facilities. This guide explores how manufacturers like CareGuard achieve these benchmarks through ultrasonic seam technology and specialized SMS fabric layering.',
